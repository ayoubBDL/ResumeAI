...
ALTER TABLE IF EXISTS public.resumes DROP CONSTRAINT IF EXISTS resumes_status_check;
...
ALTER TABLE public.resumes
  ...
  ADD CONSTRAINT resumes_status_check CHECK (status IN ('processing', 'completed', 'failed'));
